...
- First sentence of paragraph is a introduction. No Quotes etc
- "l" for only line (l. 2) and "ll" for multiple (ll. 2-3)
- no short forms
- Use simple present (e.g. "Shakespeare usese...")
- Not "shows" always, use different synonymns
- workm**a**n vs workm**e**n
- Not: "Lower ... as" use "than"
- Shakespear**e**
- playful $\neq$ full
